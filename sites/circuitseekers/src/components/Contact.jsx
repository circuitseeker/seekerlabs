...
const contacts = [
  { label: 'CircuitSeekers', value: 'circuit@seekerlab.in', href: 'mailto:circuit@seekerlab.in' },
          ...
          <div className="md:col-span-9">
            <div ref={headRef} className="reveal">
              <p className="text-[26px] md:text-[34px] lg:text-[40px] font-heading font-bold leading-[1.15] tracking-[-0.03em] text-[#0a0a0a]">
                Got a hardware challenge?<br />Let&rsquo;s solve it.
              </p>
              <p className="mt-6 text-[15px] text-neutral-600 leading-[1.8] max-w-[480px]">
                Whether it&rsquo;s an IoT prototype, a PCB design, or a firmware challenge you need solved &mdash;
            ...
            <div className="mt-10 reveal">
              <a href="mailto:circuit@seekerlab.in" className="brutal-btn">
