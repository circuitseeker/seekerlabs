          ...
          <div className="md:col-span-9">
            <div ref={headRef} className="reveal">
              <p className="text-[26px] md:text-[34px] lg:text-[40px] font-heading font-bold leading-[1.15] tracking-[-0.03em] text-[#0a0a0a]">
                DreamonFX Studios is the creative and VFX arm of SeekerLabs. We bring stories to life
                through stunning visuals and cinematic craftsmanship.
              </p>
            </div>
            <div ref={bodyRef} className="reveal">
              <div className="mt-12 brutal-card p-8 md:p-10">
                <p className="text-[15px] text-neutral-600 leading-[1.8]">
                  We are a team of editors, VFX artists, motion designers, and colorists obsessed with visual storytelling.
                  From YouTube content to feature-film-grade VFX &mdash;
                  we handle it all with craft and precision.
                </p>
                <p className="mt-6 text-[15px] text-neutral-600 leading-[1.8]">
                  Part of the SeekerLabs alliance alongside ProgramBee (software) and CircuitSeekers (hardware),
                  we bring a full-spectrum approach to creative production. You get cinematic depth
