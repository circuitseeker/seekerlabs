      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-10">
          <div>
            <span className="font-heading text-[24px] font-bold tracking-[-0.03em] text-[#0a0a0a]">
              Dreamon<span className="text-[#EF5350]">FX</span>
            </span>
            <p className="text-[13px] text-neutral-600 mt-2 leading-[1.6]">
              The creative &amp; VFX arm of SeekerLabs.<br />
              Part of the ProgramBee &amp; CircuitSeekers alliance. Est. 2021.
            </p>
          </div>
        ...
        <div className="mt-8">
          ...
          >
            ...
            <span className="text-[12px] text-neutral-600 font-medium tracking-[0.06em] uppercase">
        ...
        <div className="mt-8 pt-6 border-t-[2.5px] border-[#0a0a0a]">
          <p className="text-[12px] text-neutral-500 font-medium tracking-[0.02em]">
            &copy; {new Date().getFullYear()} DreamonFX Studios &middot; A SeekerLabs company. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
