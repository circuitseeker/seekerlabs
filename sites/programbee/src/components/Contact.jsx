...
const contacts = [
  { label: 'ProgramBee', value: 'programbee@seekerlab.in', href: 'mailto:programbee@seekerlab.in' },
          ...
          <div className="md:col-span-9">
            <div ref={headRef} className="reveal">
              <p className="text-[26px] md:text-[34px] lg:text-[40px] font-heading font-bold leading-[1.15] tracking-[-0.03em] text-[#0a0a0a]">
                Got an idea?<br />Let&rsquo;s build it.
              </p>
              <p className="mt-6 text-[15px] text-neutral-600 leading-[1.8] max-w-[480px]">
                Whether it&rsquo;s an MVP, a full product, or a technical challenge you need solved &mdash;
                reach out and we&rsquo;ll get back within 24 hours.
              </p>
            </div>

            <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-5" ref={listRef}>
              {contacts.map((item) => (
                <a
                  key={item.label}
                  href={item.href}
            ...
            <div className="mt-10 reveal">
              <a href="mailto:programbee@seekerlab.in" className="brutal-btn">
