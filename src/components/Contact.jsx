        ...
        <div className="grid md:grid-cols-12 gap-10 md:gap-20">
          ...
          <div className="md:col-span-9">
            <div ref={headRef} className="reveal">
              ...
              <p className="mt-6 text-[15px] text-[#4A6274]/70 leading-[1.8] max-w-[480px]">
            ...
            <div className="mt-12 flex flex-col sm:flex-row gap-6" ref={listRef}>
              {contacts.map((item) => (
                ...
                >
                  <p className="text-[11px] font-bold text-[#4A6274]/50 uppercase tracking-[0.14em] mb-3">
                    {item.label}
                  </p>
                  <p className="text-[17px] font-heading font-bold text-[#4A6274] tracking-[-0.01em] group-hover:text-[#C8943E] transition-colors">
                    {item.value}
                  </p>
                </a>
              ))}
