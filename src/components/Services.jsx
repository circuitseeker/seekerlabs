          ...
          <div className="md:col-span-9" ref={listRef}>
            <div className="grid sm:grid-cols-2 gap-6">
              {services.map((service) => (
                ...
                >
                  <span className="font-heading text-[11px] font-bold text-[#C8943E] bg-[#0a0a0a] inline-block px-2 py-1 mb-4 tracking-wider">
                    {service.num}
                  </span>
                  <h3 className="text-[16px] font-heading font-bold text-[#0a0a0a] mb-3 tracking-[-0.02em]">
                    {service.title}
                  </h3>
                  <p className="text-[13px] text-[#0a0a0a]/60 leading-[1.75]">
                    {service.description}
                  </p>
                </div>
              ))}
