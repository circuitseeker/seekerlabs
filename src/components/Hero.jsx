  ...
  return (
    <section className="pt-32 pb-20 md:pt-44 md:pb-28 px-6 lg:px-8" ref={containerRef}>
      <div className="max-w-[1200px] mx-auto">
        ...
        <h1 className="font-heading text-[40px] sm:text-[56px] md:text-[72px] lg:text-[84px] font-bold leading-[1.0] tracking-[-0.04em] text-[#4A6274]">
        ...
        <div className="hero-sub reveal mt-10 max-w-[520px]">
          <p className="text-[16px] text-[#4A6274]/70 leading-[1.7]">
